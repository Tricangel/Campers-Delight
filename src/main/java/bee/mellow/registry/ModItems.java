...
public class ModItems {
    ...
    public static final Item MARSHMELLOW_STICK = register("marshmellow_stick", CampfireRoastable::new, new Item.Properties()
            .component(ModItemComponents.COOKED_LEVEL, 0).component(ModItemComponents.CAN_EAT, true).component(DataComponents.CONSUMABLE, new Consumable(35, ItemUseAnimation.EAT, SoundEvents.GENERIC_EAT, true, List.of())).stacksTo(1));
    ...
    public static final Item SMORE = register("smore", CampfirePlaceable::new, new Item.Properties()
            .component(ModItemComponents.COOKED_LEVEL, 0).food(new FoodProperties(1, 1, true)));

    public static final Item MARSHMELLOW = register("marshmellow", Item::new, new Item.Properties().food(new FoodProperties(1, 1, true)));
